<?php
namespace Sozo\ProductDownloads\Controller;
    ...
    public function match(RequestInterface $request)
    {
        if (! $this->dispatched) {
            ...
            $this->eventManager->dispatch(
                'sozo_productdownloads_controller_router_match_before',
                [
                    'router' => $this,
                    'condition' => $condition
                ]
            ...
            $entities = [
                'downloads' => [
                    ...
                    'suffix' => $this->scopeConfig->getValue(
                        'sozo_productdownloads/download/url_suffix',
                        ScopeInterface::SCOPE_STORES
                    ),
                    'list_key' => $this->scopeConfig->getValue(
                        'sozo_productdownloads/download/list_url',
                        ScopeInterface::SCOPE_STORES
                    ),
                    'list_action' => 'index',
                    'factory' => $this->downloadFactory,
                    'controller' => 'product',
                    'action' => 'view',
                    'param' => 'id',
                ]
            ...
            foreach ($entities as $entity => $settings) {
                ...
                $request->
                    setModuleName('sozo_productdownloads')->
